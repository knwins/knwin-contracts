...
contract Rzuki is Ownable, ERC721A, ReentrancyGuard {
    ...
    constructor(string memory initBaseURI) ERC721A("Rzuki", "RZK", 50, 1888) {
    ...
    //-----------AllowListMint------------------------
    uint256 public allowListMintPrice = 0.001000 ether;
    bool public allowListStatus = false;
    uint256 public allowListMintAmount = 888;
    uint256 public immutable maxPerAddressDuringMint = 2;

    function setAllowListMintPrice(uint256 newAllowListMintPrice) external onlyOwner {
        require(newAllowListMintPrice >= 0, "AllowList mint price must be greater than zero");
